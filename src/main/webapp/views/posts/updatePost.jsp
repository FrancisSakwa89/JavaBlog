                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            <h3 class="text-center">Update Post Page
                            </h3>
                            <p><span style="color:red"><%=(request.getAttribute("dMsg") == null) ? "" : request.getAttribute("dMsg")%></span></p>
                            <div class="form-group">
                                <label for="postTitle">Post Id</label><br>
                                <input type="number" name="postId" id="postId" value="${post.id}" class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="postTitle">New Post Title</label><br>
                            ...
                            <div class="form-group">
                                <input type="submit" name="submit" class="btn btn-success btn-md" value="Update Post">
