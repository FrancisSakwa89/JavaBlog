        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="basicExampleNav">
                ...
                <ul class="navbar-nav mr-auto smooth-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#best-features">Technology</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#examples">Posts</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container-fluid d-flex align-items-center justify-content-center h-100">
                ...
                <div class="row d-flex justify-content-center text-center">
                    ...
                    <div class="col-md-10">
                        ...
                        <a href="allPosts"><button type="button" class="btn btn-outline-white">Read more<i class="fa fa-book ml-2"></i></button></a>
        ...
        <section id="best-features" class="text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <a href="allPosts" class="btn btn-primary btn-md">Read more</a>
